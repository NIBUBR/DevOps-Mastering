...
# Example 16 — List GitHub Actions Workflows
...
# Example 17 — Watch Workflow Execution
...
# Example 18 — Search Repositories
...
# Example 19 — Fork Repository

```bash id="s0jlwm"
gh repo fork kubernetes/kubernetes
```

---

# Example 20 — Delete Repository

```bash id="2njlwm"
gh repo delete kmit-project
```

GitHub CLI asks confirmation before deleting.

---

# Real Beginner Workflow Example
...
```bash id="0jlwm5"
gh repo create kmit-project --public --source=. --push
```
